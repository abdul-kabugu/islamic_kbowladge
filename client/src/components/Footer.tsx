export default function Footer() {
  ...
  return (
    <footer className="bg-islamic-green text-white py-16">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          {/* Brand Section */}
          <div className="md:col-span-2">
            <div className="flex items-center space-x-3 mb-6">
              <div className="w-12 h-12 bg-gradient-to-br from-warm-orange to-warm-yellow rounded-full flex items-center justify-center">
                <span className="text-white font-bold text-xl font-amiri">ش</span>
              </div>
              <div>
                <h3 className="text-2xl font-bold font-amiri">الشيخ شاهد</h3>
                <p className="text-white/80">Sheikh Shahid Muhammad Zaid</p>
              </div>
            </div>
            <p className="text-white/80 leading-relaxed mb-4">
              Utanama Pwa Uharimu wa Salaf - Tunatoa mafunzo ya Kiislamu yanayofuata Qur'an na Sunnah kwa mujibu wa uelewa wa Salaf as-Salihin.
            </p>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-semibold mb-4 font-playfair">Viungo vya Haraka</h4>
        ...
        <div className="border-t border-white/20 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-white/60 text-sm">© 2024 Sheikh Shahid Muhammad Zaid. Haki zote zimehifadhiwa.</p>
          <p className="text-white/60 text-sm font-amiri mt-2 md:mt-0">والله أعلم</p>
        </div>
      </div>
    </footer>
  );
